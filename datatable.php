...
if($_GET['type']=="fundsearch")
{
$aColumns = array( 's.id','s.sname','s.balance','s.funds','b.branch','s.contact','s.joindate');
	
	/* Indexed column (used for fast and accurate table cardinality) */
	$sIndexColumn = "s.id";
	
	/* DB table to use */
	$sTable = " customer as s,branch as b ";
	...
	{
	$condArr[] = "s.sname like '%".mysqli_real_escape_string($conn,$_GET['customer'])."%'";
